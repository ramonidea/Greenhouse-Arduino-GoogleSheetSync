...
IPAddress ip(00,00,00,00); //Arduino IP address. Only used when DHCP is turned off.
...
void loop(){
 //---------------//
  ...
  float h = dht.readHumidity();
   ...
   data+="";
  data+="GET /pushingbox?devid=#INSERTDEVID#&temp="; //GET request query to pushingbox API
  data+=f;
  data+="&hum=";
  data+=h;
  data+="&index=";
